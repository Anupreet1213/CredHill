...
export default function CustomSelectComp() {
  ...
  return (
    <CustomSelect defaultValue={10}>
      <StyledOption value={10} onClick={() => handleClick("Documentation")}>
        Documentation
      </StyledOption>
      <StyledOption value={20} onClick={() => handleClick("Components")}>
        Components
      </StyledOption>
      <StyledOption value={30} onClick={() => handleClick("Features")}>
        Features
      </StyledOption>
    </CustomSelect>
  );
